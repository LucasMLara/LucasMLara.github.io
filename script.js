  ...
  const projects = [
    ...
    },
    {
      ...
      mockupAccent: "#C96868",
      descPT: "Clínica de estética avançada sem presença digital estruturada. Criamos uma landing page de pré-lançamento focada em captura de leads via lista VIP e WhatsApp, com copy baseado nas objeções reais das pacientes — especialmente o medo de resultado artificial.",
      descEN: "Advanced aesthetics clinic with no structured digital presence. We built a pre-launch landing page focused on lead capture via VIP waitlist and WhatsApp, with copy built around real patient objections — especially the fear of looking artificial.",
      impactLabelWipPT: "// quer saber mais sobre esse projeto?",
      impactLabelWipEN: "// want to know more about this project?",
